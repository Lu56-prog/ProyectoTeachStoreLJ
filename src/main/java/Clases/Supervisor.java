...
public class Supervisor extends Empleado{
    ...
    public Supervisor(String id, String nombre, int cedula, String telefono, String correo, String cargo, String profesion, double salario, LocalDate fechaIngreso, String jornadaLaboral, int descuentoAutorizado, int ventaMayoresAutorizadas) {
