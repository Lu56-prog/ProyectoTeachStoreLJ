...
public class TeachStoreLJ { 
    ...
    public static void main(String[] args) {
        ...
        usuarios.listaEmpleados.add(new Cajero("Juan Pérez", "1023456789", "3004567890", "juanperez@gmail.com", "Cajero", "Administrador", 1800000, "Tiempo completo"));
        ...
        inventario.listaSDigitales.add(new ServicioDigital("Instalación de sistema operativo y configuración básica",150000.0,"Software y sistemas",Duration.ofMinutes(180),"Instalación de Windows o Linux con optimización inicial del sistema.", (Tecnico) usuarios.listaEmpleados.get(1)));
        inventario.listaSDigitales.add(new ServicioDigital("Configuración de red doméstica o empresarial",220000.0,"Redes y conectividad",Duration.ofMinutes(180),"Montaje, conexión y configuración de red LAN o WiFi.",(Tecnico) usuarios.listaEmpleados.get(0)));
