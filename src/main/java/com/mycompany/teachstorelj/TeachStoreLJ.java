...
public class TeachStoreLJ { 
    ...
    public static void main(String[] args) {
       ...
       inventario.listaProductos.add(new ProductoFisico("Laptop ASUS", 2500000, "Computadoras", "Samsung", 10, "Bodega 1", 5));
       ...
       inventario.listaProductos.add(new ProductoFisico("Impresora HP", 650000, "Periféricos", "HP", 12, "Bodega 2", 0));
