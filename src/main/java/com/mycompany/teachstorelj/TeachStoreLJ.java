...
public class TeachStoreLJ { 
    ...
    public static void main(String[] args) {
        ...
        empleados.listaEmpleados.add(new Tecnico("T001", "Juan Pérez", 1023456789, "3124567890", "juanperez@techstore.com", "Técnico de redes", "Ingeniero en Telecomunicaciones", 2800000, LocalDate.of(2021, 5, 10), "Tiempo completo", 3, true));
        empleados.listaEmpleados.add(new Tecnico("T002", "María Gómez", 1019876543, "3109876543", "mariagomez@techstore.com", "Técnica en mantenimiento", "Tecnóloga en Electrónica", 2400000, LocalDate.of(2022, 8, 25), "Medio tiempo", 2, true));
